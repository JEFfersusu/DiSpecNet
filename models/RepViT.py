...
class RepViT(nn.Module):
    def __init__(self, cfgs, num_classes=12, distillation=False):
...
@register_model
def repvit_m0_6(pretrained=False, num_classes=7, distillation=False):
    """
...
@register_model
def repvit_m0_9(pretrained=False, num_classes=12, distillation=False):
    """
    Constructs a MobileNetV3-Large model
    """
    cfgs = [
